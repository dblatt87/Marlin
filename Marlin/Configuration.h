...
/*                                       S GND 5V
     ...
     o f o            PA14       PW_DET PA2  (UART TMC2209, X/Y/E0)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 500, 600 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 800, 900 } // ...or, set your own edit limits
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.03  // (mm) Distance from real junction edge org 0.03
...
#define NOZZLE_TO_PROBE_OFFSET { 0, -32.0, -2.26 }
...
#define Y_MIN_POS 0     // setting don't work
#define Z_MIN_POS 0
