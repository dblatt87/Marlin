...
#define ASSISTED_TRAMMING
  ...
  // Define positions for probing points, use the hotend as reference not the sensor. Back 257
  #define TRAMMING_POINT_XY { {  30, 13 }, { 270,  13 }, { 270, 242 }, { 30, 242 } }
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG0 Z20\nG90\nG0 X150 Y280"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define G0_FEEDRATE 18000 // (mm/min)
#ifdef G0_FEEDRATE
...
//#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Advanced"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN  // Return to status screen after a script

  #define MAIN_MENU_ITEM_1_DESC "PID Nozzle"
  #define MAIN_MENU_ITEM_1_GCODE "M303 C5 E0 S205"
  ...
  #define MAIN_MENU_ITEM_4_DESC "PID Bed"
  #define MAIN_MENU_ITEM_4_GCODE "M303 C5 E1 S65"
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Tramming"
  #define MAIN_MENU_ITEM_5_GCODE "G35"
