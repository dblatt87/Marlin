...
/*
  BLTOUCH testing:
    ...
    M119 ; should return OPEN. If not check that the BLTouch is enabled in the configuration. 
    If enabled then check wiring and check that the correct pin is being used. 
    Also check that Z_MIN_ENDSTOP_INVERTING and Z_MIN_PROBE_ENDSTOP_INVERTING are both set to "false".
    ...
    If it's ON then the unit needs to be adjusted.
    ...
    M280 P0 S120 -> Selftest
    M48 P4-50 -> reliability
*/
...
#define STRING_CONFIG_H_AUTHOR "(dome)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  36.4
  #define DEFAULT_bedKi   7.1
  #define DEFAULT_bedKd 124.5
...
#define TMC_BAUD_RATE                     19200 //115200

/*                                       S GND 5V
     o   o        ISP?                X PA15 (ES X)
     o   o            VSS             Y PA12 (ES Y)
     o w o       VDD-o o o-VSS       Z- PA11 (ES Z1)
     o i o      PA13-o o o-NRST      Z+ PC4  (ES Z2)
     o f o            PA14       PW_DET PA2  
     o i o                      MT_DET1 PA4  (MT DET)
 PA9-o   o                      MT_DET2 PE6  (BL TOUCH)
PA10-o   o                          PB2 PB2  (UART TMC2209, X/Y/E0)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.16, 80.16, 400, 677 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 30, 30 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 500, 600 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 600, 1000 } // ...or, set your own edit limits
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.05 // (mm) Distance from real junction edge (0.013)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -30, -2.26 }
...
#define X_MIN_POS -2  // Centre printable area on the bed, must be negativ
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 340   // end of rail
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE_TRAVEL 250    // (mm/s) Feedrate for G26 XY travel moves.
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X 17264
  #define TOUCH_CALIBRATION_Y -11677
