...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 35 }, { 270,  35 }, { 270, 255 }, { 30, 255 } }
  ...
  #define REPORT_TRAMMING_ABS_DEGREES   // Report deviation from Probe (not first pos) and in °
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu

  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, 270, 30 } // Move the nozzle out of the way for adjustment
